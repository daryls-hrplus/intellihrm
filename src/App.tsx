      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <TranslationsProvider>
            ...
            <Route path="/compensation/review-flags" element={<ProtectedRoute moduleCode="compensation"><LazyPage><Pages.CompensationReviewFlagsPage /></LazyPage></ProtectedRoute>} />
            ...
            <Route path="/hr-hub/directory-privacy" element={<ProtectedRoute requiredRoles={["admin", "hr_manager"]}><LazyPage><Pages.DirectoryPrivacyConfigPage /></LazyPage></ProtectedRoute>} />
            ...
            <Route path="/enablement/manuals/succession" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.SuccessionManualPage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
            <Route path="/enablement/manuals/career-development" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.CareerDevelopmentManualPage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
            <Route path="/enablement/manuals/learning-development" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.LearningDevelopmentManualPage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
            ...
            <Route path="/enablement/quickstart/time-attendance" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.TAQuickStartPage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
            ...
            <Route path="/enablement/standards" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.PlatformStandardsPage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
            <Route path="/enablement/standards/workspace-navigation" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.WorkspaceNavigationStandardPage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
            <Route path="/enablement/release-center" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.ReleaseCommandCenterPage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
            <Route path="/enablement/release-center/guide" element={<ProtectedRoute><EnablementAccessGuard><LazyPage><Pages.ReleaseCommandCenterGuidePage /></LazyPage></EnablementAccessGuard></ProtectedRoute>} />
