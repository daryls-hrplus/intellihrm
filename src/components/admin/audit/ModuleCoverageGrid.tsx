      ...
      <CardContent>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {moduleCoverages.map((module, index) => {
            ...
            const coverageColor = getCoverageColor(module.activityLevel);
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge variant={getCoverageBadgeVariant(module.activityLevel)} className="text-xs">
                    {getCoverageStatusLabel(module.activityLevel)}
                  </Badge>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-baseline justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {module.activeEntityTypes.length}/{module.implementedEntityTypes.length} active
                    </span>
                  </div>
                  
                  <Progress value={module.activityLevel} className="h-1.5" />
