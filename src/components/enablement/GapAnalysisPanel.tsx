  ...
  const categories = [
    {
      ...
      icon: FileX,
      color: "text-[hsl(var(--semantic-error-text))]",
    },
    {
      id: "noKB",
      label: "Missing KB",
      ...
      icon: FileQuestion,
      color: "text-[hsl(var(--semantic-warning-text))]",
    },
    {
      id: "noQuickStart",
      ...
      icon: Rocket,
      color: "text-[hsl(var(--semantic-info-text))]",
    },
    {
      id: "noSOP",
      label: "Missing SOP",
      ...
      icon: ClipboardList,
      color: "text-[hsl(var(--semantic-neutral-text))]",
    },
    {
      id: "orphaned",
      label: "Orphaned",
