...
export function CompanyCommunications() {
  return (
    <div className="space-y-8">
      ...
      {/* Section 5.3.1: Announcements */}
      <div id="hh-sec-5-3-1" data-manual-anchor="hh-sec-5-3-1" className="space-y-6 scroll-mt-36">
        <div className="flex items-center gap-3 mb-4">
          <Badge variant="secondary" className="text-xs">5.3.1</Badge>
      ...
      {/* Section 5.3.2: Photo Gallery */}
      <div id="hh-sec-5-3-2" data-manual-anchor="hh-sec-5-3-2" className="space-y-6 scroll-mt-36">
        <div className="flex items-center gap-3 mb-4">
          <Badge variant="secondary" className="text-xs">5.3.2</Badge>
          <h3 className="text-lg font-semibold flex items-center gap-2">
      ...
      {/* Section 5.3.3: Blog Posts */}
      <div id="hh-sec-5-3-3" data-manual-anchor="hh-sec-5-3-3" className="space-y-6 scroll-mt-36">
        <div className="flex items-center gap-3 mb-4">
          <Badge variant="secondary" className="text-xs">5.3.3</Badge>
          <h3 className="text-lg font-semibold flex items-center gap-2">
