...
export function HelpDeskSetup() {
  return (
    <div className="space-y-8">
      ...
      {/* Section 6.1.1: Operations */}
      <div id="hh-sec-6-1-1" data-manual-anchor="hh-sec-6-1-1" className="space-y-6 scroll-mt-36">
        <div className="flex items-center gap-3 mb-4">
          <Badge variant="secondary" className="text-xs">6.1.1</Badge>
      ...
      {/* Section 6.1.2: Monitoring */}
      <div id="hh-sec-6-1-2" data-manual-anchor="hh-sec-6-1-2" className="space-y-6 scroll-mt-36">
        <div className="flex items-center gap-3 mb-4">
          <Badge variant="secondary" className="text-xs">6.1.2</Badge>
          <h3 className="text-lg font-semibold flex items-center gap-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <p className="text-sm text-muted-foreground">
              The Monitoring section provides real-time visibility into Help Desk performance 
      ...
      {/* Section 6.1.3: Configuration */}
      <div id="hh-sec-6-1-3" data-manual-anchor="hh-sec-6-1-3" className="space-y-6 scroll-mt-36">
        <div className="flex items-center gap-3 mb-4">
          <Badge variant="secondary" className="text-xs">6.1.3</Badge>
          <h3 className="text-lg font-semibold flex items-center gap-2">
