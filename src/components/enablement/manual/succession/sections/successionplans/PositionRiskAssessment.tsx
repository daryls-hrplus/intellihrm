...
export function PositionRiskAssessment() {
  const keyPositionRiskFields: FieldDefinition[] = [
    ...
    { name: 'criticality_level', required: true, type: 'Text', description: 'Business criticality level', defaultValue: 'high', validation: 'low, medium, high, critical' },
    ...
    { name: 'impact_if_vacant_en', required: false, type: 'Text', description: 'English translation of business impact description' },
    { name: 'current_incumbent_id', required: false, type: 'UUID', description: 'Reference to current employee in position' },
    { name: 'retirement_risk', required: false, type: 'Boolean', description: 'Flag indicating retirement risk exists', defaultValue: 'false' },
    { name: 'flight_risk', required: false, type: 'Boolean', description: 'Flag indicating flight risk exists', defaultValue: 'false' },
    { name: 'risk_notes', required: false, type: 'Text', description: 'Additional risk factors and mitigation notes' },
    { name: 'risk_notes_en', required: false, type: 'Text', description: 'English translation of risk notes' },
    { name: 'assessed_at', required: false, type: 'Timestamp', description: 'When risk was last assessed' },
