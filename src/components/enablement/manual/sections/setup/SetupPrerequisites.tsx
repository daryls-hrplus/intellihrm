        ...
        <div>
          ...
          <div className="p-4 bg-muted/50 rounded-lg">
            <div className="flex flex-wrap items-center gap-2 text-sm">
              <Badge className="bg-blue-100 text-blue-700">Rating Scales</Badge>
              <span>→</span>
              <Badge className="bg-blue-100 text-blue-700">Competency Library</Badge>
              <span>→</span>
              <Badge className="bg-blue-100 text-blue-700">Job Profiles</Badge>
              <span>→</span>
              <Badge className="bg-green-100 text-green-700">Form Templates</Badge>
              <span>→</span>
              <Badge className="bg-green-100 text-green-700">Appraisal Cycles</Badge>
            </div>
