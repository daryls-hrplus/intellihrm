...
const EMPLOYEE_MANAGEMENT_SECTIONS = [
  ...
  { id: 'wf-sec-4-6', num: '4.6', title: 'Multi-Position Employees', desc: 'Concurrent positions, FTE split allocation', time: 8, Component: MultiPositionEmployees },
  { id: 'wf-sec-4-7', num: '4.7', title: 'Employee Transactions', desc: 'Promotions, transfers, demotions, grade changes', time: 12, Component: EmployeeTransactions },
  // Compliance & Identity (4.8-4.11)
  { id: 'wf-sec-4-8', num: '4.8', title: 'Government IDs Management', desc: 'ID documents, expiry tracking', time: 8, Component: GovernmentIdsManagement },
  { id: 'wf-sec-4-9', num: '4.9', title: 'Immigration & Work Permits', desc: 'Visa, permit expiry tracking', time: 10, Component: ImmigrationWorkPermits },
  { id: 'wf-sec-4-10', num: '4.10', title: 'Background Checks', desc: 'Pre-employment screening', time: 8, Component: BackgroundChecks },
  { id: 'wf-sec-4-11', num: '4.11', title: 'References & Verifications', desc: 'Reference check management', time: 6, Component: ReferencesVerifications },
  // Payroll & Benefits (4.12-4.15)
  { id: 'wf-sec-4-12', num: '4.12', title: 'Banking & Payment Setup', desc: 'Bank accounts, payment methods', time: 8, Component: BankingPaymentSetup },
  { id: 'wf-sec-4-13', num: '4.13', title: 'Dependents & Beneficiaries', desc: 'Family records for benefits', time: 8, Component: DependentsBeneficiaries },
  { id: 'wf-sec-4-14', num: '4.14', title: 'Employee Benefits Enrollment', desc: 'Plan assignment, coverage', time: 10, Component: EmployeeBenefitsEnrollment },
  { id: 'wf-sec-4-15', num: '4.15', title: 'Medical Information', desc: 'Emergency medical data, allergies', time: 6, Component: MedicalInformation },
  // Skills & Development (4.16-4.19)
  { id: 'wf-sec-4-16', num: '4.16', title: 'Employee Languages', desc: 'Language proficiency levels', time: 6, Component: EmployeeLanguages },
  { id: 'wf-sec-4-17', num: '4.17', title: 'Employee Skills & Competencies', desc: 'Skill inventory, assessments', time: 10, Component: EmployeeSkillsCompetencies },
  { id: 'wf-sec-4-18', num: '4.18', title: 'Skill Gap Analysis', desc: 'Development needs identification', time: 8, Component: SkillGapAnalysis },
  { id: 'wf-sec-4-19', num: '4.19', title: 'Credentials & Memberships', desc: 'Professional certifications', time: 6, Component: CredentialsMemberships },
  // Documentation & Legal (4.20-4.23)
  { id: 'wf-sec-4-20', num: '4.20', title: 'Employee Documents', desc: 'Document management, expiry tracking', time: 8, Component: EmployeeDocuments },
  { id: 'wf-sec-4-21', num: '4.21', title: 'Agreements & Signatures', desc: 'Contracts, policy acknowledgments', time: 8, Component: AgreementsSignatures },
  { id: 'wf-sec-4-22', num: '4.22', title: 'Evidence Portfolio', desc: 'Capability evidence, validation', time: 8, Component: EvidencePortfolio },
  { id: 'wf-sec-4-23', num: '4.23', title: 'Compliance & Legal', desc: 'Regulatory compliance tracking', time: 8, Component: ComplianceLegal },
  // Extensions & Directory (4.24-4.26)
