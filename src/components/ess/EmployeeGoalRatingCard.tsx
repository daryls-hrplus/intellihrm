...
import { Target, ChevronDown, ChevronUp, Paperclip, CheckCircle2 } from "lucide-react";
import { cn } from "@/lib/utils";

interface EmployeeGoalRatingCardProps {
  goalId: string;
  goalName: string;
  weight: number;
...
export function EmployeeGoalRatingCard({
  goalId,
  goalName,
  weight,
  currentRating,
          ...
          <CardContent className="pt-4 pb-3 cursor-pointer hover:bg-accent/50 transition-colors">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <div className={cn(
                  "p-2 rounded-lg",
                  isComplete ? "bg-green-100 dark:bg-green-900/30" : "bg-pink-100 dark:bg-pink-900/30"
                )}>
                  {isComplete ? (
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-medium text-sm truncate">{goalName}</h4>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                <Label className="text-sm">
                  ...
                  <span className="text-muted-foreground ml-1">(Describe how you met this goal)</span>
                </Label>
                <Textarea
                  value={comments}
                  onChange={(e) => onCommentsChange(e.target.value)}
                  placeholder="Describe your achievements, key results, and evidence for this rating..."
                  rows={3}
                  disabled={readOnly}
