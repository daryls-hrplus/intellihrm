...
const TEMPLATE_CONFIGS: Record<string, { 
  ...
  departments: {
    headers: ["code", "name", "company_code", "division_code", "parent_department_code", "description", "start_date", "end_date", "is_active"],
    fields: [
      ...
      { name: "parent_department_code", required: false, description: "Parent department code for hierarchy (optional)", example: "" },
    ...
    tips: [
      ...
      "Division code is OPTIONAL - leave blank if your company doesn't use divisions or if this department links directly to the company",
      ...
      "Use parent_department_code to create department hierarchies within the same company",
    ],
  },
  divisions: {
