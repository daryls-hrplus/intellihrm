...
export const ImportValidationReport = forwardRef<HTMLDivElement, ImportValidationReportProps>(
  function ImportValidationReport({ result, isValidating, onDownloadReport }, ref) {
    if (isValidating) {
      return (
        <div ref={ref} className="flex flex-col items-center justify-center py-12 space-y-4">
