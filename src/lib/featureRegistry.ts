  ...
  groups: [
    ...
    },
    {
      ...
      features: [
        ...
        { code: "capability_framework", name: "Capability Framework", description: "Manage organizational skills, competencies, and values", routePath: "/workforce/capability-registry", icon: "Layers", tabCode: "competencies", roleRequirements: ["admin", "hr_manager"], workflowSteps: ["Create skill/competency/value", "Define proficiency levels", "Link to jobs"], uiElements: ["Skills list", "Competency list", "Values list", "Proficiency editor", "Job linker"] },
  ...
  groups: [
    {
      ...
      features: [
        ...
        { code: "salary_overtime", name: "Pay Period Entries", description: "Manage compensation entries for pay periods", routePath: "/payroll/entries", icon: "Clock", tabCode: "salary_overtime", roleRequirements: ["admin"], workflowSteps: ["Select period", "Enter data", "Validate entries"], uiElements: ["Entry grid", "Data form", "Validation panel"] },
        ...
        { code: "overpayment_recovery", name: "Overpayment Recovery", description: "Track and manage overpayment recoveries", routePath: "/payroll/overpayment-recovery", icon: "AlertCircle", tabCode: "overpayment_recovery", roleRequirements: ["admin"], workflowSteps: ["Record overpayment", "Approve recovery", "Track deductions"], uiElements: ["Recovery dashboard", "Approval workflow", "Payment history"] },
