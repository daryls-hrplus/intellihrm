  ...
  groups: [
    ...
    },
    {
      ...
      features: [
        ...
        { code: "skills_competencies", name: "Skills & Competencies", description: "Manage organizational skills and competency framework", routePath: "/workforce/capability-registry", icon: "Target", tabCode: "competencies", roleRequirements: ["admin", "hr_manager"], workflowSteps: ["Create skill/competency", "Define proficiency levels", "Link to jobs"], uiElements: ["Skills list", "Competency list", "Proficiency editor", "Job linker"] },
