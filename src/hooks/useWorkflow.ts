...
export type WorkflowCategory = 'leave_request' | 'probation_confirmation' | 'headcount_request' | 'training_request' | 'promotion' | 'transfer' | 'resignation' | 'termination' | 'expense_claim' | 'letter_request' | 'general' | 'qualification' | 'hire' | 'rehire' | 'confirmation' | 'probation_extension' | 'acting' | 'secondment' | 'salary_change' | 'rate_change' | 'performance' | 'disciplinary_acknowledgement' | 'grievance_submission' | 'ess_approval' | 'goal_approval' | 'rating_approval' | 'feedback_360_approval' | 'calibration_approval' | 'succession_approval' | 'learning_approval' | 'pip_acknowledgment' | 'rating_release_approval' | 'goal_approval_individual' | 'goal_approval_team' | 'goal_approval_department' | 'certification_request' | 'external_training' | 'recertification_request' | 'training_budget' | 'succession_nomination' | 'succession_plan_approval' | 'talent_pool_nomination' | 'succession_emergency' | 'goal_cascade' | 'goal_modification' | 'idp_approval' | 'career_path_approval' | 'mentorship_approval' | 'development_assignment' | 'career_move_request' | 'continuous_feedback' | 'midcycle_review' | 'pip_extension' | 'pip_closure' | 'appraisal_reopen' | 'key_position_designation' | 'bench_strength_review' | 'flight_risk_acknowledgment' | 'retention_action_approval' | 'ninebox_override' | 'feedback_360_release' | 'feedback_360_investigation' | 'feedback_360_external' | 'feedback_360_cycle';
