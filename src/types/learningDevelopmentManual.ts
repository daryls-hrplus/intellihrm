...
export const LND_MANUAL_STRUCTURE: LndSection[] = [
  ...
  // ==========================================================================
  {
    ...
    description: 'Day-to-day training operations including enrollment, requests, progress tracking, assessments, and certifications.',
    contentLevel: 'procedure',
    estimatedReadTime: 90,
    ...
    subsections: [
      ...
      },
      {
        id: 'sec-4-3',
        sectionNumber: '4.3',
        title: 'Training Request by Gap Analysis',
      ...
      },
      {
        id: 'sec-4-4',
        sectionNumber: '4.4',
        title: 'Training Request via Performance Appraisal',
        description: 'Appraisal-triggered training requests and development plan integration',
        contentLevel: 'procedure',
        estimatedReadTime: 6,
      ...
      },
      {
        id: 'sec-4-5',
        sectionNumber: '4.5',
        title: 'Training Request via Self-Service',
        description: 'Employee-initiated training requests through ESS portal',
        contentLevel: 'procedure',
        estimatedReadTime: 5,
      ...
      },
      {
        id: 'sec-4-6',
        sectionNumber: '4.6',
        title: 'Training Request via Onboarding',
      ...
      },
      {
        id: 'sec-4-7',
        sectionNumber: '4.7',
        title: 'HR-Initiated Training Requests',
        description: 'Bulk enrollment and HR-generated training assignments',
        contentLevel: 'procedure',
        estimatedReadTime: 5,
        targetRoles: ['Admin', 'HR Partner'],
      ...
      },
      {
        ...
        description: 'Manager-to-employee training invitations and acceptance workflows',
        contentLevel: 'procedure',
        estimatedReadTime: 5,
        targetRoles: ['Manager'],
      ...
      },
      {
        ...
        description: 'Certificate generation, certificate numbers, digital delivery, and validation',
        contentLevel: 'procedure',
        estimatedReadTime: 5,
        targetRoles: ['Admin', 'L&D Admin']
      },
      {
        ...
        description: 'Historical record keeping, import utilities, and audit trail maintenance',
        contentLevel: 'procedure',
        estimatedReadTime: 5,
        targetRoles: ['Admin', 'HR Partner'],
      ...
      },
      {
        ...
        sectionNumber: '4.14',
        title: 'External Training Records',
        description: 'Record training completed outside LMS, vendor tracking, and cost capture',
        contentLevel: 'procedure',
        estimatedReadTime: 5,
        targetRoles: ['Admin', 'HR Partner']
      },
      {
        id: 'sec-4-15',
        sectionNumber: '4.15',
        title: 'Training Calendar Operations',
        description: 'Session scheduling, conflict resolution, and calendar integration',
        contentLevel: 'procedure',
        estimatedReadTime: 6,
        targetRoles: ['Admin', 'L&D Admin'],
        legacyReference: 'Training Calendar'
