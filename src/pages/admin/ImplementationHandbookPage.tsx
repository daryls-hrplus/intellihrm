...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { order: 3, area: "Policy Documents", description: "Upload company policies for RAG integration" },
      { order: 4, area: "SOPs", description: "Standard operating procedures (separate knowledge base)" },
      { order: 5, area: "Knowledge Base", description: "Help articles and user guides" },
      { order: 6, area: "Reminder Rules", description: "Automated notifications for key dates" },
      { order: 7, area: "Scheduled Reports", description: "Automated report delivery" },
      { order: 8, area: "AI Budget Tiers", description: "Define tiers: ESS ($1), MSS ($5), Core ($10), Admin (unlimited)" },
      { order: 9, area: "AI User Settings", description: "Assign tiers to users, custom budget overrides" },
      { order: 10, area: "AI Guardrails", description: "Configure 8 guardrails: role security, policy, SOP, help center, PII, audit, disclaimer, escalation" },
      { order: 11, area: "AI Voice Settings", description: "Enable/disable ElevenLabs TTS per user" },
      { order: 12, area: "AI System Settings", description: "Company-level AI enable/disable, allowed models, token limits" },
      { order: 13, area: "AI Usage Monitoring", description: "Track monthly usage by user with budget remaining" },
    ],
  },
  {
    id: "billing",
