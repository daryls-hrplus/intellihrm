...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { order: 14, area: "Goal Templates", description: "Create reusable goal structures by job/department" },
      { order: 15, area: "Goal Locking Rules", description: "Configure when goals can be modified" },
      { order: 16, area: "Check-in Cadence", description: "Set up regular goal progress check-ins" },
      { order: 17, area: "Goal Rating Configuration", description: "Define goal achievement rating scale" },
      { order: 18, area: "360 Feedback Configuration", description: "Configure multi-source feedback dimensions and rater rules" },
      // 6D: Cycles & Operations (Company)
      { order: 19, area: "Appraisal Cycles Configuration", description: "Create annual/quarterly review cycles" },
      { order: 20, area: "Integration Rules (Downstream)", description: "Link outcomes to compensation, training, succession" },
      { order: 21, area: "Integration Status Dashboard", description: "Monitor downstream integration status" },
      { order: 22, area: "Calibration Session Setup", description: "Configure calibration meetings and participants" },
      { order: 23, area: "AI Calibration Features", description: "Enable AI-assisted rating suggestions" },
      // 6E: Talent Management (Company)
      { order: 24, area: "Nine-Box Grid Configuration", description: "Define performance vs potential axes" },
      { order: 25, area: "Talent Pools", description: "Create high-potential and succession pools" },
      { order: 26, area: "Key Positions", description: "Identify and flag critical roles" },
      { order: 27, area: "Succession Plans", description: "Map successors with readiness levels" },
      { order: 28, area: "Career Paths", description: "Define progression routes by job family" },
      { order: 29, area: "Mentorship Programs", description: "Configure mentor matching and programs" },
      // 6F: Support & PIPs (Company)
      { order: 30, area: "Performance Improvement Plans", description: "PIP templates with milestones and checkpoints" },
      { order: 31, area: "Recognition Programs", description: "Awards, badges, and recognition workflows" },
    ],
  },
  {
    id: "auxiliary",
