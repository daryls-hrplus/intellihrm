...
import { AdminManualOverviewSection } from '@/components/enablement/admin-manual';
    ...
    switch (activePartId) {
      ...
      case 'admin-part-2':
        return (
          <Card>
            <CardHeader>
              <CardTitle>Part 2: Foundation Setup</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">Organization hierarchy configuration content coming soon...</p>
            </CardContent>
          </Card>
        );
      case 'admin-part-3':
        return (
          <Card>
            <CardHeader>
              <CardTitle>Part 3: Users & Roles Configuration</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">Role architecture and permissions content coming soon...</p>
            </CardContent>
          </Card>
        );
      case 'admin-part-4':
        return (
          <Card>
            <CardHeader>
              <CardTitle>Part 4: Security Configuration</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">Authentication, MFA, and security policies content coming soon...</p>
            </CardContent>
          </Card>
        );
      case 'admin-part-5':
        return (
          <Card>
            <CardHeader>
              <CardTitle>Part 5: System Configuration</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">System settings and customization content coming soon...</p>
            </CardContent>
          </Card>
        );
      case 'admin-part-6':
        return (
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">AI system settings and ISO 42001 compliance content coming soon...</p>
            </CardContent>
          </Card>
        );
      case 'admin-part-7':
        return (
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">Regulatory framework and audit trail content coming soon...</p>
            </CardContent>
          </Card>
        );
      case 'admin-part-8':
