...
import { 
  ...
  Clock, FileText, Lightbulb, AlertTriangle, History
} from 'lucide-react';
...
export default function ArtifactDetailPage() {
  ...
  const [tabState, setTabState] = useTabState({
    defaultState: { activeTab: "content" },
  });
  ...
  const handleEditArtifact = () => {
    if (!id) return;
    navigateToRecord({
      route: `/enablement/artifacts/${id}/edit`,
      title: `Edit: ${artifact?.title || 'Artifact'}`,
      subtitle: "Edit Artifact",
      moduleCode: "enablement",
      contextType: "artifact-edit",
      contextId: id,
      icon: Edit,
    });
  };
        ...
        <div className="container mx-auto py-6">
          <Breadcrumbs
            items={[
              ...
              { label: "Artifacts", href: "/enablement/artifacts" },
              { label: "Not Found" },
            ]}
          />
          <Card className="mt-6">
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <Button variant="outline" className="mt-4" onClick={handleBackToArtifacts}>
      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-start gap-4">
            <Button variant="ghost" size="icon" onClick={handleBackToArtifacts}>
          ...
          <div className="flex items-center gap-2">
            {artifact.status === 'draft' && (
              <Button variant="outline" onClick={handleEditArtifact}>
        ...
        <Dialog open={showDeprecateDialog} onOpenChange={setShowDeprecateDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Provide a reason for deprecating this artifact</DialogDescription>
            </DialogHeader>
            <Textarea
            ...
            <DialogFooter>
              ...
              <Button variant="destructive" onClick={() => handleAction('deprecate')}>Deprecate</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
