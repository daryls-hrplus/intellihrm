...
import { ClipboardCheck, ArrowLeft, GraduationCap } from "lucide-react";
...
export default function TrainingEvaluationsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("training.modules.evaluations.title") },
  ];
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        {companyId && <TrainingEvaluationsTab companyId={companyId} />}
      </div>
    </AppLayout>
  );
}
