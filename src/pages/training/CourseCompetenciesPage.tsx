...
import { Link, ArrowLeft, GraduationCap } from "lucide-react";
...
export default function CourseCompetenciesPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("training.modules.courseCompetencies.title") },
  ];
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        {companyId && <CourseCompetenciesTab companyId={companyId} />}
      </div>
    </AppLayout>
  );
}
