...
export default function OpenShiftBoardPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("timeAttendance.shifts.openShifts") }
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold">{t("timeAttendance.shifts.openShifts")}</h1>
          </div>
