...
export default function ShiftManagementPage() {
  ...
  const navigationCards = [
    ...
    { title: t("timeAttendance.shifts.templatesLabel"), description: t("timeAttendance.shifts.templatesDescription"), href: "/time-attendance/shifts/templates", icon: Copy, color: "bg-cyan-500/20 text-cyan-600" },
    { title: t("timeAttendance.shifts.rotationsLabel"), description: t("timeAttendance.shifts.rotationsDescription"), href: "/time-attendance/shifts/rotations", icon: RotateCcw, color: "bg-indigo-500/20 text-indigo-600" },
    { title: t("timeAttendance.shifts.fatigueLabel"), description: t("timeAttendance.shifts.fatigueDescription"), href: "/time-attendance/shifts/fatigue", icon: AlertTriangle, color: "bg-red-500/20 text-red-600" },
