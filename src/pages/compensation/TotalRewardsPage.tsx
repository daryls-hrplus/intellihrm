      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight">Total Rewards Statements</h1>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Avg. Total Comp</p>
                      ...
                      <TableRow key={statement.id}>
                        ...
                        <TableCell>
                          <Badge className={statement.is_published ? "bg-emerald-500/10 text-emerald-600" : "bg-amber-500/10 text-amber-600"}>
                            {statement.is_published ? "Published" : "Draft"}
                          </Badge>
                        </TableCell>
                      </TableRow>
                    ))
