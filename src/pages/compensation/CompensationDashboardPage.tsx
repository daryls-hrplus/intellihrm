...
export default function CompensationDashboardPage() {
  ...
  const allModules = {
    ...
    positionCompensation: { title: t("compensation.modules.positionCompensation.title"), description: t("compensation.modules.positionCompensation.description"), href: "/compensation/position", icon: Wallet, color: "bg-sky-500/10 text-sky-600", tabCode: "position_compensation" },
    employeeCompensation: { title: t("compensation.modules.employeeCompensation.title"), description: t("compensation.modules.employeeCompensation.description"), href: "/compensation/employee", icon: Users, color: "bg-blue-500/10 text-blue-600", tabCode: "employee_compensation" },
    ...
    bonus: { title: t("compensation.modules.bonus.title"), description: t("compensation.modules.bonus.description"), href: "/compensation/bonuses", icon: Gift, color: "bg-rose-500/10 text-rose-600", tabCode: "bonus" },
    marketBenchmarking: { title: t("compensation.modules.marketBenchmarking.title"), description: t("compensation.modules.marketBenchmarking.description"), href: "/compensation/benchmarking", icon: BarChart3, color: "bg-indigo-500/10 text-indigo-600", tabCode: "market_benchmarking" },
    ...
    positionBudgeting: { title: "Position Budgeting", description: "Workforce planning with position-based budgets, scenarios & what-if modeling", href: "/compensation/position-budget", icon: Briefcase, color: "bg-purple-500/10 text-purple-600", tabCode: "position_budgeting" },
    minimumWageCompliance: { title: "Minimum Wage Compliance", description: "Monitor and manage minimum wage compliance across your workforce", href: "/compensation/minimum-wage", icon: Shield, color: "bg-red-500/10 text-red-600", tabCode: "minimum_wage_compliance" },
    ...
    reviewFlags: { title: "Performance Review Flags", description: "Review compensation actions triggered by performance appraisals", href: "/compensation/review-flags", icon: Flag, color: "bg-amber-500/10 text-amber-600", tabCode: "review_flags" },
  };
  ...
  const sections: ModuleSection[] = [
    ...
    {
      titleKey: "Incentives",
      items: filterByAccess([allModules.meritCycles, allModules.bonus, allModules.equity, allModules.totalRewards, allModules.reviewFlags]),
    },
    {
