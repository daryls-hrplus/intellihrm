...
const compensationModules = [
  ...
  { title: "Bonus Management", description: "Manage bonus plans and awards", href: "/compensation/bonuses", icon: Gift, color: "bg-rose-500/10 text-rose-600" },
  { title: "Market Benchmarking", description: "Compare to market data", href: "/compensation/benchmarking", icon: BarChart3, color: "bg-indigo-500/10 text-indigo-600" },
