...
export default function EmployeeSelfServicePage() {
  ...
  const allModules = {
    ...
    myAppraisals: { title: t("ess.modules.myAppraisals.title", "My Appraisals"), description: t("ess.modules.myAppraisals.description", "View and manage your performance appraisals"), href: "/ess/appraisals", icon: ClipboardCheck, color: "bg-violet-500/10 text-violet-600", tabCode: "ess-my-appraisals" },
    development: { title: t("ess.modules.development.title", "My Development Plan"), description: t("ess.modules.development.description", "View and manage your development goals"), href: "/ess/development-plan", icon: TrendingUp, color: "bg-purple-500/10 text-purple-600", tabCode: "ess-development" },
    ...
    employeeDirectory: { title: t("ess.modules.employeeDirectory.title", "Employee Directory"), description: t("ess.modules.employeeDirectory.description", "Find and connect with colleagues"), href: "/ess/employee-directory", icon: Users, color: "bg-blue-500/10 text-blue-600", tabCode: "ess-employee-directory" },
