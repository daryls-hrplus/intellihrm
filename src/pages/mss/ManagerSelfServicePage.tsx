...
export default function ManagerSelfServicePage() {
  ...
  const allModules = {
    ...
    feedback360: { title: t("mss.modules.360.title", "360 Reviews & Development"), description: t("mss.modules.360.description", "Manage 360° feedback cycles and development themes"), href: "/mss/360", icon: Users, color: "bg-rose-500/10 text-rose-600", tabCode: "mss-360" },
    ...
    feedback: { title: t("mss.modules.feedback.title", "Continuous Feedback"), description: t("mss.modules.feedback.description", "Provide ongoing feedback and recognition"), href: "/mss/feedback", icon: MessageCircle, color: "bg-violet-500/10 text-violet-600", tabCode: "mss-feedback" },
