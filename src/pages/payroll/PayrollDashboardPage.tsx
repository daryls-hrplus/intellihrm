...
export default function PayrollDashboardPage() {
  ...
  const allModules = {
    ...
    salaryOvertime: { title: "Pay Period Payroll Entries", description: "Manage compensation entries for pay periods", icon: Clock, href: "/payroll/entries", color: "bg-accent/10 text-accent-foreground", tabCode: "salary_overtime" },
    ...
    semiMonthlyRules: { title: "Semi-Monthly Rules", description: "Configure statutory and deduction handling for semi-monthly payroll", icon: CalendarRange, href: "/payroll/semi-monthly-rules", color: "bg-cyan-500/10 text-cyan-600", tabCode: "semimonthly_rules" },
    tipPools: { title: "Tips & Tronc", description: "Manage tip pooling and tronc distribution for hospitality", icon: Coins, href: "/payroll/tip-pool", color: "bg-amber-500/10 text-amber-600", tabCode: "tip_pools" },
