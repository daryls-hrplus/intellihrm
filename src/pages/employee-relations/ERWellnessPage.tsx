...
export default function ERWellnessPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("employeeRelationsModule.wellness.title") },
  ];
      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">{t("employeeRelationsModule.wellness.title")}</h1>
              <p className="text-muted-foreground">{t("employeeRelationsModule.wellness.description")}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        {selectedCompanyId && <ERWellnessTab companyId={selectedCompanyId} />}
      </div>
    </AppLayout>
  );
}
