...
import { ERUnionsTab } from "@/components/employee-relations/ERUnionsTab";
import { Building2 } from "lucide-react";

export default function ERUnionsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("employeeRelationsModule.unions.title") },
  ];
      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">{t("employeeRelationsModule.unions.title")}</h1>
              <p className="text-muted-foreground">{t("employeeRelationsModule.unions.description")}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        {selectedCompanyId && <ERUnionsTab companyId={selectedCompanyId} />}
      </div>
    </AppLayout>
  );
}
