...
import { ERGrievancesTab } from "@/components/employee-relations/ERGrievancesTab";
import { FileText } from "lucide-react";

export default function ERGrievancesPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("employeeRelationsModule.grievances.title") },
  ];
      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">{t("employeeRelationsModule.grievances.title")}</h1>
              <p className="text-muted-foreground">{t("employeeRelationsModule.grievances.description")}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        {selectedCompanyId && <ERGrievancesTab companyId={selectedCompanyId} departmentId={selectedDepartmentId !== "all" ? selectedDepartmentId : undefined} />}
      </div>
    </AppLayout>
  );
}
