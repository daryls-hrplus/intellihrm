...
import { ERCourtJudgementsTab } from "@/components/employee-relations/ERCourtJudgementsTab";
import { Gavel } from "lucide-react";

export default function ERCourtJudgementsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("employeeRelationsModule.courtJudgements.title") },
  ];
      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">{t("employeeRelationsModule.courtJudgements.title")}</h1>
              <p className="text-muted-foreground">{t("employeeRelationsModule.courtJudgements.description")}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        {selectedCompanyId && <ERCourtJudgementsTab companyId={selectedCompanyId} />}
      </div>
    </AppLayout>
  );
}
