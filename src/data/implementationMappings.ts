...
export const PHASE_STEP_MAPPINGS: Record<string, StepMapping[]> = {
  ...
  performance: [
    ...
    { order: 9, area: "Appraisal Outcome Rules", adminRoute: "/performance/setup?tab=appraisals&sub=outcome-rules", isRequired: false, estimatedMinutes: 30, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.8", isGlobal: false },
