...
export const PHASE_STEP_MAPPINGS: Record<string, StepMapping[]> = {
  ...
  performance: [
    ...
    { order: 7, area: "Action Rules Configuration", adminRoute: "/admin/appraisal-action-rules", isRequired: false, estimatedMinutes: 25, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.3", isGlobal: false },
    { order: 8, area: "Employee Response Configuration", adminRoute: "/admin/appraisal-responses", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.4", isGlobal: false },
    { order: 9, area: "HR Escalation Settings", adminRoute: "/admin/appraisal-escalations", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.5", isGlobal: false },
    { order: 10, area: "Multi-Position Appraisals Setup", adminRoute: "/admin/multi-position-appraisals", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.6", isGlobal: false },
    { order: 11, area: "Benchmarks (Distribution Targets)", adminRoute: "/admin/rating-benchmarks", isRequired: false, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.7", isGlobal: false },
