...
export const PHASE_STEP_MAPPINGS: Record<string, StepMapping[]> = {
  ...
  performance: [
    ...
    { order: 1, area: "Rating Scales Configuration", adminRoute: "/performance/setup?tab=foundation&sub=rating-scales", isRequired: true, estimatedMinutes: 20, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.2", isGlobal: true },
    { order: 2, area: "Overall Rating Scales Setup", adminRoute: "/performance/setup?tab=foundation&sub=overall-scales", isRequired: true, estimatedMinutes: 15, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.3", isGlobal: true },
    { order: 3, area: "Skills vs Competencies Foundation", adminRoute: "/workforce/capability-registry", isRequired: true, estimatedMinutes: 12, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4a", isGlobal: true },
    { order: 4, area: "Competency Library Integration", adminRoute: "/performance/setup?tab=foundation&sub=competencies", isRequired: true, estimatedMinutes: 25, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4", isGlobal: true },
    { order: 5, area: "Index Settings (Multi-Cycle)", adminRoute: "/performance/setup?tab=foundation&sub=index-settings", isRequired: false, estimatedMinutes: 10, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.5", isGlobal: true },
    { order: 6, area: "Approval Workflows Configuration", adminRoute: "/performance/setup?tab=foundation&sub=approval-workflows", isRequired: true, estimatedMinutes: 18, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4-wf", isGlobal: true },
    { order: 7, area: "Performance Notification Templates", adminRoute: "/performance/setup?tab=foundation&sub=notifications", isRequired: true, estimatedMinutes: 15, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4b", isGlobal: true },
    // 6B: Appraisal Configuration (Company-specific)
    { order: 8, area: "Rating Levels Setup", adminRoute: "/performance/setup?tab=appraisals&sub=performance-categories", isRequired: true, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.7", isGlobal: false },
    { order: 9, area: "Appraisal Form Templates", adminRoute: "/performance/setup?tab=appraisals&sub=form-templates", isRequired: true, estimatedMinutes: 45, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.1", isGlobal: false },
    { order: 10, area: "Action Rules Configuration", adminRoute: "/performance/setup?tab=appraisals&sub=action-rules", isRequired: false, estimatedMinutes: 25, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.8", isGlobal: false },
    { order: 11, area: "Employee Response Configuration", adminRoute: "/performance/setup?tab=appraisals&sub=employee-response", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.4", isGlobal: false },
    { order: 12, area: "HR Escalation Settings", adminRoute: "/performance/setup?tab=appraisals&sub=hr-escalations", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.5", isGlobal: false },
    { order: 13, area: "Benchmarks (Distribution Targets)", adminRoute: "/performance/setup?tab=appraisals&sub=benchmarks", isRequired: false, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.7", isGlobal: false },
    // 6C: Goals & Feedback (Company-specific)
    { order: 14, area: "Goal Cycles Configuration", adminRoute: "/performance/setup?tab=goals&sub=goal-cycles", isRequired: false, estimatedMinutes: 20, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.1", isGlobal: false },
    { order: 15, area: "Goal Templates", adminRoute: "/performance/setup?tab=goals&sub=goal-templates", isRequired: false, estimatedMinutes: 25, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.2", isGlobal: false },
    { order: 16, area: "Goal Locking Rules", adminRoute: "/performance/setup?tab=goals&sub=goal-locking", isRequired: false, estimatedMinutes: 10, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.3", isGlobal: false },
    { order: 17, area: "Check-in Cadence", adminRoute: "/performance/setup?tab=goals&sub=check-in-cadence", isRequired: false, estimatedMinutes: 15, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.4", isGlobal: false },
    { order: 18, area: "Goal Rating Configuration", adminRoute: "/performance/setup?tab=goals&sub=rating-config", isRequired: false, estimatedMinutes: 15, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.4b", isGlobal: false },
    { order: 19, area: "360 Feedback Configuration", adminRoute: "/performance/setup?tab=360-feedback", isRequired: false, estimatedMinutes: 30, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.5", isGlobal: false },
    // 6D: Cycles & Operations (Company-specific)
    { order: 20, area: "Appraisal Cycles Configuration", adminRoute: "/performance/setup?tab=appraisals&sub=appraisal-cycles", isRequired: true, estimatedMinutes: 35, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.1", isGlobal: false },
    { order: 21, area: "Integration Rules (Downstream)", adminRoute: "/performance/setup?tab=appraisals&sub=integration-rules", isRequired: false, estimatedMinutes: 25, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3", isGlobal: false },
    { order: 22, area: "Integration Status Dashboard", adminRoute: "/performance/setup?tab=appraisals&sub=integration-dashboard", isRequired: false, estimatedMinutes: 10, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3b", isGlobal: false },
    { order: 23, area: "Calibration Session Setup", adminRoute: "/performance/appraisals?tab=calibration", isRequired: false, estimatedMinutes: 30, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.4", isGlobal: false },
    { order: 24, area: "AI Calibration Features", adminRoute: "/performance/appraisals?tab=talent", isRequired: false, estimatedMinutes: 20, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.5", isGlobal: false },
    // 6E: Talent Management (Company-specific)
    { order: 25, area: "Nine-Box Grid Configuration", adminRoute: "/talent/nine-box", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.1", isGlobal: false },
    { order: 26, area: "Talent Pools", adminRoute: "/talent/pools", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.2", isGlobal: false },
    { order: 27, area: "Key Positions", adminRoute: "/talent/key-positions", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.3", isGlobal: false },
    { order: 28, area: "Succession Plans", adminRoute: "/talent/succession", isRequired: false, estimatedMinutes: 35, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.4", isGlobal: false },
    { order: 29, area: "Career Paths", adminRoute: "/talent/career-paths", isRequired: false, estimatedMinutes: 30, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.5", isGlobal: false },
    { order: 30, area: "Mentorship Programs", adminRoute: "/talent/mentorship", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.6", isGlobal: false },
    // 6F: Support & PIPs (Company-specific)
    { order: 31, area: "Performance Improvement Plans", adminRoute: "/performance/pips", isRequired: false, estimatedMinutes: 30, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.1", isGlobal: false },
    { order: 32, area: "Recognition Programs", adminRoute: "/performance/setup?tab=recognition&sub=recognition-categories", isRequired: false, estimatedMinutes: 25, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.2", isGlobal: false },
  ],
  auxiliary: [
