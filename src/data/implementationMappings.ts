...
export const PHASE_STEP_MAPPINGS: Record<string, StepMapping[]> = {
  ...
  performance: [
    ...
    { order: 5, area: "Index Settings (Multi-Cycle)", adminRoute: "/admin/appraisal-index", isRequired: false, estimatedMinutes: 10, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.5", isGlobal: true },
    ...
    { order: 7, area: "Rating Levels Setup", adminRoute: "/performance/setup", isRequired: true, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.7", isGlobal: false },
    { order: 8, area: "Action Rules Configuration", adminRoute: "/admin/appraisal-action-rules", isRequired: false, estimatedMinutes: 25, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.8", isGlobal: false },
    { order: 9, area: "Employee Response Configuration", adminRoute: "/admin/appraisal-responses", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.4", isGlobal: false },
    { order: 10, area: "HR Escalation Settings", adminRoute: "/admin/appraisal-escalations", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.5", isGlobal: false },
    { order: 11, area: "Multi-Position Appraisals Setup", adminRoute: "/admin/multi-position-appraisals", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.6", isGlobal: false },
    { order: 12, area: "Benchmarks (Distribution Targets)", adminRoute: "/admin/rating-benchmarks", isRequired: false, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.7", isGlobal: false },
    // 6C: Goals & Feedback (Company-specific)
    { order: 13, area: "Goal Framework (OKR/SMART)", adminRoute: "/admin/goal-framework", isRequired: false, estimatedMinutes: 20, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.1", isGlobal: false },
    { order: 14, area: "Goal Templates", adminRoute: "/admin/goal-templates", isRequired: false, estimatedMinutes: 25, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.2", isGlobal: false },
    { order: 15, area: "Goal Locking Rules", adminRoute: "/admin/goal-locking", isRequired: false, estimatedMinutes: 10, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.3", isGlobal: false },
    { order: 16, area: "Check-in Cadence", adminRoute: "/admin/goal-checkins", isRequired: false, estimatedMinutes: 15, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.4", isGlobal: false },
    { order: 17, area: "360 Feedback Configuration", adminRoute: "/admin/360-feedback", isRequired: false, estimatedMinutes: 30, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.5", isGlobal: false },
    { order: 18, area: "Anonymity Settings", adminRoute: "/admin/feedback-anonymity", isRequired: false, estimatedMinutes: 10, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.6", isGlobal: false },
    // 6D: Cycles & Operations (Company-specific)
    { order: 19, area: "Appraisal Cycles Configuration", adminRoute: "/admin/appraisal-cycles", isRequired: true, estimatedMinutes: 35, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.1", isGlobal: false },
    { order: 20, area: "Participant Enrollment Rules", adminRoute: "/admin/appraisal-enrollment", isRequired: false, estimatedMinutes: 20, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.2", isGlobal: false },
    { order: 21, area: "Integration Rules (Downstream)", adminRoute: "/admin/appraisal-integrations", isRequired: false, estimatedMinutes: 25, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3", isGlobal: false },
    { order: 22, area: "Calibration Session Setup", adminRoute: "/admin/calibration-sessions", isRequired: false, estimatedMinutes: 30, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.4", isGlobal: false },
    { order: 23, area: "AI Calibration Features", adminRoute: "/admin/ai-calibration", isRequired: false, estimatedMinutes: 20, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.5", isGlobal: false },
    // 6E: Talent Management (Company-specific)
    { order: 24, area: "Nine-Box Grid Configuration", adminRoute: "/admin/nine-box-config", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.1", isGlobal: false },
    { order: 25, area: "Talent Pools", adminRoute: "/admin/talent-pools", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.2", isGlobal: false },
    { order: 26, area: "Key Positions", adminRoute: "/admin/key-positions", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.3", isGlobal: false },
    { order: 27, area: "Succession Plans", adminRoute: "/admin/succession-plans", isRequired: false, estimatedMinutes: 35, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.4", isGlobal: false },
    { order: 28, area: "Career Paths", adminRoute: "/admin/career-paths", isRequired: false, estimatedMinutes: 30, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.5", isGlobal: false },
    { order: 29, area: "Mentorship Programs", adminRoute: "/admin/mentorship", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.6", isGlobal: false },
    // 6F: Support & PIPs (Company-specific)
    { order: 30, area: "Performance Improvement Plans", adminRoute: "/admin/pip-templates", isRequired: false, estimatedMinutes: 30, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.1", isGlobal: false },
    { order: 31, area: "Recognition Programs", adminRoute: "/admin/recognition-programs", isRequired: false, estimatedMinutes: 25, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.2", isGlobal: false },
    { order: 32, area: "Notification Orchestration", adminRoute: "/admin/performance-notifications", isRequired: false, estimatedMinutes: 20, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.3", isGlobal: false },
  ],
  auxiliary: [
