...
export const PHASE_STEP_MAPPINGS: Record<string, StepMapping[]> = {
  ...
  performance: [
    ...
    { order: 3, area: "Skills vs Competencies Foundation", adminRoute: "/workforce/capability-registry", isRequired: true, estimatedMinutes: 25, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4", isGlobal: true },
    { order: 4, area: "Index Settings (Multi-Cycle)", adminRoute: "/performance/setup?tab=foundation&sub=index-settings", isRequired: false, estimatedMinutes: 10, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.5", isGlobal: true },
    { order: 5, area: "Approval Workflows Configuration", adminRoute: "/performance/setup?tab=foundation&sub=approval-workflows", isRequired: true, estimatedMinutes: 18, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4-wf", isGlobal: true },
    { order: 6, area: "Performance Notification Templates", adminRoute: "/performance/setup?tab=foundation&sub=notifications", isRequired: true, estimatedMinutes: 15, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4b", isGlobal: true },
    // 6B: Appraisal Configuration (Company-specific)
    { order: 7, area: "Rating Levels Setup", adminRoute: "/performance/setup?tab=appraisals&sub=performance-categories", isRequired: true, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.7", isGlobal: false },
    { order: 8, area: "Appraisal Form Templates", adminRoute: "/performance/setup?tab=appraisals&sub=form-templates", isRequired: true, estimatedMinutes: 45, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.1", isGlobal: false },
    { order: 9, area: "Action Rules Configuration", adminRoute: "/performance/setup?tab=appraisals&sub=action-rules", isRequired: false, estimatedMinutes: 25, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.8", isGlobal: false },
    { order: 10, area: "Employee Response Configuration", adminRoute: "/performance/setup?tab=appraisals&sub=employee-response", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.4", isGlobal: false },
    { order: 11, area: "HR Escalation Settings", adminRoute: "/performance/setup?tab=appraisals&sub=hr-escalations", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.5", isGlobal: false },
    { order: 12, area: "Benchmarks (Distribution Targets)", adminRoute: "/performance/setup?tab=appraisals&sub=benchmarks", isRequired: false, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.7", isGlobal: false },
    // 6C: Goals & Feedback (Company-specific)
    { order: 13, area: "Goal Cycles Configuration", adminRoute: "/performance/setup?tab=goals&sub=goal-cycles", isRequired: false, estimatedMinutes: 20, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.1", isGlobal: false },
    { order: 14, area: "Goal Templates", adminRoute: "/performance/setup?tab=goals&sub=goal-templates", isRequired: false, estimatedMinutes: 25, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.2", isGlobal: false },
    { order: 15, area: "Goal Locking Rules", adminRoute: "/performance/setup?tab=goals&sub=goal-locking", isRequired: false, estimatedMinutes: 10, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.3", isGlobal: false },
    { order: 16, area: "Check-in Cadence", adminRoute: "/performance/setup?tab=goals&sub=check-in-cadence", isRequired: false, estimatedMinutes: 15, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.4", isGlobal: false },
    { order: 17, area: "Goal Rating Configuration", adminRoute: "/performance/setup?tab=goals&sub=rating-config", isRequired: false, estimatedMinutes: 15, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.4b", isGlobal: false },
    { order: 18, area: "360 Feedback Configuration", adminRoute: "/performance/setup?tab=360-feedback", isRequired: false, estimatedMinutes: 30, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.5", isGlobal: false },
    // 6D: Cycles & Operations (Company-specific)
    { order: 19, area: "Appraisal Cycles Configuration", adminRoute: "/performance/setup?tab=appraisals&sub=appraisal-cycles", isRequired: true, estimatedMinutes: 35, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.1", isGlobal: false },
    { order: 20, area: "Integration Rules (Downstream)", adminRoute: "/performance/setup?tab=appraisals&sub=integration-rules", isRequired: false, estimatedMinutes: 25, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3", isGlobal: false },
    { order: 21, area: "Integration Status Dashboard", adminRoute: "/performance/setup?tab=appraisals&sub=integration-dashboard", isRequired: false, estimatedMinutes: 10, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3b", isGlobal: false },
    { order: 22, area: "Calibration Session Setup", adminRoute: "/performance/appraisals?tab=calibration", isRequired: false, estimatedMinutes: 30, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.4", isGlobal: false },
    { order: 23, area: "AI Calibration Features", adminRoute: "/performance/appraisals?tab=talent", isRequired: false, estimatedMinutes: 20, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.5", isGlobal: false },
    // 6E: Talent Management (Company-specific)
    { order: 24, area: "Nine-Box Grid Configuration", adminRoute: "/talent/nine-box", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.1", isGlobal: false },
    { order: 25, area: "Talent Pools", adminRoute: "/talent/pools", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.2", isGlobal: false },
    { order: 26, area: "Key Positions", adminRoute: "/talent/key-positions", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.3", isGlobal: false },
    { order: 27, area: "Succession Plans", adminRoute: "/talent/succession", isRequired: false, estimatedMinutes: 35, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.4", isGlobal: false },
    { order: 28, area: "Career Paths", adminRoute: "/talent/career-paths", isRequired: false, estimatedMinutes: 30, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.5", isGlobal: false },
    { order: 29, area: "Mentorship Programs", adminRoute: "/talent/mentorship", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.6", isGlobal: false },
    // 6F: Support & PIPs (Company-specific)
    { order: 30, area: "Performance Improvement Plans", adminRoute: "/performance/pips", isRequired: false, estimatedMinutes: 30, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.1", isGlobal: false },
    { order: 31, area: "Recognition Programs", adminRoute: "/performance/setup?tab=recognition&sub=recognition-categories", isRequired: false, estimatedMinutes: 25, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.2", isGlobal: false },
  ],
  auxiliary: [
