...
export const PHASE_STEP_MAPPINGS: Record<string, StepMapping[]> = {
  ...
  performance: [
    ...
    { order: 3, area: "Skills vs Competencies Foundation", adminRoute: "/workforce/skills-competencies", isRequired: true, estimatedMinutes: 12, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4a", isGlobal: true },
    { order: 4, area: "Competency Library Integration", adminRoute: "/workforce/skills-competencies", isRequired: true, estimatedMinutes: 25, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4", isGlobal: true },
    { order: 5, area: "Approval Workflows Configuration", adminRoute: "/admin/workflow-templates", isRequired: true, estimatedMinutes: 18, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4-wf", isGlobal: true },
    { order: 6, area: "Performance Notification Templates", adminRoute: "/admin/performance-notifications", isRequired: true, estimatedMinutes: 15, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.4b", isGlobal: true },
    { order: 7, area: "Index Settings (Multi-Cycle)", adminRoute: "/admin/appraisal-index", isRequired: false, estimatedMinutes: 10, subSection: "6A: Core Framework Setup", sourceManual: "appraisals", sourceSection: "Part 2.5", isGlobal: true },
    // 6B: Appraisal Configuration (Company-specific)
    { order: 8, area: "Appraisal Form Templates", adminRoute: "/admin/appraisal-templates", isRequired: true, estimatedMinutes: 45, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.1", isGlobal: false },
    { order: 9, area: "Rating Levels Setup", adminRoute: "/performance/setup", isRequired: true, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.7", isGlobal: false },
    { order: 10, area: "Action Rules Configuration", adminRoute: "/admin/appraisal-action-rules", isRequired: false, estimatedMinutes: 25, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 2.8", isGlobal: false },
    { order: 11, area: "Employee Response Configuration", adminRoute: "/admin/appraisal-responses", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.4", isGlobal: false },
    { order: 12, area: "HR Escalation Settings", adminRoute: "/admin/appraisal-escalations", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.5", isGlobal: false },
    { order: 13, area: "Multi-Position Appraisals Setup", adminRoute: "/admin/multi-position-appraisals", isRequired: false, estimatedMinutes: 15, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.6", isGlobal: false },
    { order: 14, area: "Benchmarks (Distribution Targets)", adminRoute: "/admin/rating-benchmarks", isRequired: false, estimatedMinutes: 20, subSection: "6B: Appraisal Configuration", sourceManual: "appraisals", sourceSection: "Part 3.7", isGlobal: false },
    // 6C: Goals & Feedback (Company-specific)
    { order: 15, area: "Goal Framework (OKR/SMART)", adminRoute: "/admin/goal-framework", isRequired: false, estimatedMinutes: 20, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.1", isGlobal: false },
    { order: 16, area: "Goal Templates", adminRoute: "/admin/goal-templates", isRequired: false, estimatedMinutes: 25, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.2", isGlobal: false },
    { order: 17, area: "Goal Locking Rules", adminRoute: "/admin/goal-locking", isRequired: false, estimatedMinutes: 10, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.3", isGlobal: false },
    { order: 18, area: "Check-in Cadence", adminRoute: "/admin/goal-checkins", isRequired: false, estimatedMinutes: 15, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.4", isGlobal: false },
    { order: 19, area: "360 Feedback Configuration", adminRoute: "/admin/360-feedback", isRequired: false, estimatedMinutes: 30, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.5", isGlobal: false },
    { order: 20, area: "Anonymity Settings", adminRoute: "/admin/feedback-anonymity", isRequired: false, estimatedMinutes: 10, subSection: "6C: Goals & Feedback", sourceManual: "appraisals", sourceSection: "Part 4.6", isGlobal: false },
    // 6D: Cycles & Operations (Company-specific)
    { order: 21, area: "Appraisal Cycles Configuration", adminRoute: "/admin/appraisal-cycles", isRequired: true, estimatedMinutes: 35, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.1", isGlobal: false },
    { order: 22, area: "Participant Enrollment Rules", adminRoute: "/admin/appraisal-enrollment", isRequired: false, estimatedMinutes: 20, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.2", isGlobal: false },
    { order: 23, area: "Integration Rules (Downstream)", adminRoute: "/admin/appraisal-integrations", isRequired: false, estimatedMinutes: 25, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3", isGlobal: false },
    { order: 24, area: "Calibration Session Setup", adminRoute: "/admin/calibration-sessions", isRequired: false, estimatedMinutes: 30, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.4", isGlobal: false },
    { order: 25, area: "AI Calibration Features", adminRoute: "/admin/ai-calibration", isRequired: false, estimatedMinutes: 20, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.5", isGlobal: false },
    // 6E: Talent Management (Company-specific)
    { order: 26, area: "Nine-Box Grid Configuration", adminRoute: "/admin/nine-box-config", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.1", isGlobal: false },
    { order: 27, area: "Talent Pools", adminRoute: "/admin/talent-pools", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.2", isGlobal: false },
    { order: 28, area: "Key Positions", adminRoute: "/admin/key-positions", isRequired: false, estimatedMinutes: 20, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.3", isGlobal: false },
    { order: 29, area: "Succession Plans", adminRoute: "/admin/succession-plans", isRequired: false, estimatedMinutes: 35, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.4", isGlobal: false },
    { order: 30, area: "Career Paths", adminRoute: "/admin/career-paths", isRequired: false, estimatedMinutes: 30, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.5", isGlobal: false },
    { order: 31, area: "Mentorship Programs", adminRoute: "/admin/mentorship", isRequired: false, estimatedMinutes: 25, subSection: "6E: Talent Management", sourceManual: "appraisals", sourceSection: "Part 6.6", isGlobal: false },
    // 6F: Support & PIPs (Company-specific)
    { order: 32, area: "Performance Improvement Plans", adminRoute: "/admin/pip-templates", isRequired: false, estimatedMinutes: 30, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.1", isGlobal: false },
    { order: 33, area: "Recognition Programs", adminRoute: "/admin/recognition-programs", isRequired: false, estimatedMinutes: 25, subSection: "6F: Support & PIPs", sourceManual: "appraisals", sourceSection: "Part 7.2", isGlobal: false },
  ],
  auxiliary: [
