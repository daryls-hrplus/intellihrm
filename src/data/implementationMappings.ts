...
export const PHASE_STEP_MAPPINGS: Record<string, StepMapping[]> = {
  ...
  performance: [
    ...
    { order: 19, area: "Appraisal Cycles Management", adminRoute: "/performance/appraisals?tab=cycles", isRequired: true, estimatedMinutes: 35, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.1", isGlobal: false },
    { order: 20, area: "Integration Rules (Downstream)", adminRoute: "/performance/setup?tab=appraisals&sub=outcome-rules", isRequired: false, estimatedMinutes: 25, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3", isGlobal: false },
    { order: 21, area: "Integration Status Dashboard", adminRoute: "/performance/appraisals?tab=integrations", isRequired: false, estimatedMinutes: 10, subSection: "6D: Cycles & Operations", sourceManual: "appraisals", sourceSection: "Part 5.3b", isGlobal: false },
