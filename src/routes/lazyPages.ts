...
export const CompanyRelationshipsPage = lazy(() => import('@/pages/admin/CompanyRelationshipsPage'));
...
export const QuickStartAdminPage = lazy(() => import('@/pages/enablement/QuickStartAdminPage'));
export const DynamicQuickStartPage = lazy(() => import('@/pages/enablement/DynamicQuickStartPage'));
...
export const DirectoryPrivacyConfigPage = lazy(() => import('@/pages/hr-hub/DirectoryPrivacyConfigPage'));
