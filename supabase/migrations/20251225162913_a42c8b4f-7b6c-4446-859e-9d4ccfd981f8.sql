...
-- Fix recalculate_leave_balance function - current_balance is a generated column, don't insert/update it
...
BEGIN
  ...
  LOOP
    ...
    -- Update or insert leave balance - DO NOT include current_balance (it's a generated column)
